    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
       ...
       new Tenant { TenantId = 5, UserId = 6, Dob = new DateOnly(1982, 7, 18), NationalId = "820752231"}
        ...
        modelBuilder.Entity<Property>().HasData(
         ...
         new Property { PropertyId = 3, Name = "United Tower", Building = "922", Road = "3062", Block = "461", City = "Riffa", Description = "A residential property with spacious apartments for families.", CreatedAt = new DateTime(2026, 1, 10) }
     );


        modelBuilder.Entity<Unit>().HasData(
       new Unit { UnitId = 1, PropertyId = 1, UnitNumber = "A1", Type = "Apartment", SizeSqFt = 100, RentAmount = 300, AvailabilityStatus = "Available", CreatedAt = new DateTime(2026, 1, 1) },
       new Unit { UnitId = 2, PropertyId = 1, UnitNumber = "A2", Type = "Apartment", SizeSqFt = 120, RentAmount = 350, AvailabilityStatus = "Occupied", CreatedAt = new DateTime(2026, 1, 2) },
       new Unit { UnitId = 3, PropertyId = 2, UnitNumber = "B1", Type = "Office", SizeSqFt = 200, RentAmount = 500, AvailabilityStatus = "Available", CreatedAt = new DateTime(2026, 1, 3) },
       new Unit { UnitId = 4, PropertyId = 2, UnitNumber = "B2", Type = "Office", SizeSqFt = 250, RentAmount = 550, AvailabilityStatus = "Occupied", CreatedAt = new DateTime(2026, 1, 4) },
       new Unit { UnitId = 5, PropertyId = 1, UnitNumber = "A3", Type = "Studio", SizeSqFt = 80, RentAmount = 250, AvailabilityStatus = "Available", CreatedAt = new DateTime(2026, 1, 5) },
       new Unit { UnitId = 6, PropertyId = 3, UnitNumber = "C1", Type = "Apartment", SizeSqFt = 110, RentAmount = 320, AvailabilityStatus = "Available", CreatedAt = new DateTime(2026, 1, 6) }
   );
      ...
      new LeaseApplication { ApplicationId = 1, TenantId = 1, UnitId = 1, ApplicationDate = new DateTime(2026, 2, 1), Status = "Approved" },
      ...
      new LeaseApplication { ApplicationId = 4, TenantId = 4, UnitId = 4, ApplicationDate = new DateTime(2026, 2, 7), Status = "Approved"},
      ...
      new Lease { LeaseId = 1, TenantId = 1, UnitId = 2, StartDate = new DateTime(2026, 3, 1), EndDate = new DateTime(2027, 3, 1), MonthlyRent = 300, Status = "Active", CreatedAt = new DateTime(2026, 3, 1) },
      new Lease { LeaseId = 2, TenantId = 2, UnitId = 3, StartDate = new DateTime(2026, 3, 5), EndDate = new DateTime(2027, 3, 5), MonthlyRent = 500, Status = "Active", CreatedAt = new DateTime(2026, 3, 5) },
      new Lease { LeaseId = 3, TenantId = 3, UnitId = 1, StartDate = new DateTime(2026, 3, 10), EndDate = new DateTime(2027, 3, 10), MonthlyRent = 350, Status = "Terminated", CreatedAt = new DateTime(2026, 3, 10) },
      new Lease { LeaseId = 4, TenantId = 4, UnitId = 4, StartDate = new DateTime(2026, 3, 12), EndDate = new DateTime(2027, 3, 12), MonthlyRent = 550, Status = "Active", CreatedAt = new DateTime(2026, 3, 12) },
      new Lease { LeaseId = 5, TenantId = 5, UnitId = 5, StartDate = new DateTime(2026, 3, 15), EndDate = new DateTime(2027, 3, 15), MonthlyRent = 250, Status = "Active", CreatedAt = new DateTime(2026, 3, 15) }
  );

        modelBuilder.Entity<Payment>().HasData(
       new Payment { PaymentId = 1, LeaseId = 1, Amount = 300, PaymentDate = new DateTime(2026, 3, 1), Status = "Paid" },
       new Payment { PaymentId = 2, LeaseId = 2, Amount = 500, PaymentDate = new DateTime(2026, 3, 5), Status = "Paid"},
       new Payment { PaymentId = 3, LeaseId = 3, Amount = 350, PaymentDate = new DateTime(2026, 3, 10), Status = "Late" },
       new Payment { PaymentId = 4, LeaseId = 4, Amount = 550, PaymentDate = new DateTime(2026, 3, 12), Status = "Paid"},
       new Payment { PaymentId = 5, LeaseId = 5, Amount = 250, PaymentDate = new DateTime(2026, 3, 15), Status = "Pending" }
   );

        modelBuilder.Entity<Notification>().HasData(
       new Notification { NotificationId = 1, UserId = 1, Message = "New lease application received", CreatedAt = new DateTime(2026, 2, 1), Type = "LeaseApplication"},
       new Notification { NotificationId = 2, UserId = 2, Message = "Your application has been approved", CreatedAt = new DateTime(2026, 2, 3), Type = "LeaseApplication"},
       new Notification { NotificationId = 3, UserId = 3, Message = "Maintenance request updated", CreatedAt = new DateTime(2026, 3, 2), Type = "MaintenanceRequest"},
       new Notification { NotificationId = 4, UserId = 4, Message = "Payment received successfully", CreatedAt = new DateTime(2026, 3, 12),Type = "Payment"},
       new Notification { NotificationId = 5, UserId = 5, Message = "Lease activated for your unit", CreatedAt = new DateTime(2026, 3, 15), Type = "Lease"},
       new Notification { NotificationId = 6, UserId = 7, Message = "New maintenance request assigned", CreatedAt = new DateTime(2026, 3, 1), Type = "MaintenanceRequest"},
       new Notification { NotificationId = 7, UserId = 8, Message = "Electrical repair marked as in progress", CreatedAt = new DateTime(2026, 3, 2), Type = "MaintenanceRequest"},
       new Notification { NotificationId = 8, UserId = 9, Message = "HVAC issue reported in Unit A2", CreatedAt = new DateTime(2026, 3, 3), Type = "MaintenanceRequest"},
       new Notification { NotificationId = 9, UserId = 10, Message = "Carpentry issue reported in Unit B2", CreatedAt = new DateTime(2026, 3, 4), Type = "MaintenanceRequest"},
       new Notification { NotificationId = 10, UserId = 11, Message = "Painting issue reported in Unit A3", CreatedAt = new DateTime(2026, 3, 5), Type = "MaintenanceRequest"}
    );
