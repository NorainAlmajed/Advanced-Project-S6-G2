...
namespace AdvancedProject.Migrations
{
    ...
    [Migration("20260514233636_AddIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdvancedProject.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AdvancedProject.Models.Governorate", b =>
                {
            ...
            modelBuilder.Entity("AdvancedProject.Models.PaymentFrequency", b =>
                {
                    b.Property<int>("PaymentFrequencyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdvancedProject.Models.PaymentMethod", b =>
                {
                    b.Property<int>("PaymentMethodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdvancedProject.Models.Payment", b =>
                {
                    ...
                    b.HasOne("AdvancedProject.Models.PaymentFrequency", "PaymentFrequency")
                        .WithMany("Payments")
                        .HasForeignKey("PaymentFrequencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AdvancedProject.Models.PaymentMethod", "PaymentMethod")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("AdvancedProject.Models.Property", b =>
                {
                    b.HasOne("AdvancedProject.Models.Governorate", "Governorate")
                        .WithMany("Properties")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AdvancedProject.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
