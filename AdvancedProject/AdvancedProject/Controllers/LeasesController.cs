...
namespace AdvancedProject.Controllers
{
    public class LeasesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LeaseId,TenantId,UnitId,StartDate,EndDate,MonthlyRent,Status,CreatedAt,TerminationDate")] Lease lease)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LeaseId,TenantId,UnitId,StartDate,EndDate,MonthlyRent,Status,CreatedAt,TerminationDate")] Lease lease)
        {
            if (id != lease.LeaseId)
            {
                return NotFound();
