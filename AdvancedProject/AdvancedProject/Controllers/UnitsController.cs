...
namespace AdvancedProject.Controllers
{
    public class UnitsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UnitId,PropertyId,UnitNumber,Type,SizeSqFt,Amenities,RentAmount,AvailabilityStatus,CreatedAt")] Unit unit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UnitId,PropertyId,UnitNumber,Type,SizeSqFt,Amenities,RentAmount,AvailabilityStatus,CreatedAt")] Unit unit)
        {
            if (id != unit.UnitId)
            {
                return NotFound();
