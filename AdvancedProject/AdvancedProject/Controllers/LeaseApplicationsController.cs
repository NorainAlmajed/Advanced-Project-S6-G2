...
namespace AdvancedProject.Controllers
{
    public class LeaseApplicationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ApplicationId,TenantId,UnitId,ApplicationDate,Status,Notes")] LeaseApplication leaseApplication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ApplicationId,TenantId,UnitId,ApplicationDate,Status,Notes")] LeaseApplication leaseApplication)
        {
