...
namespace AdvancedProject.Controllers
{
    public class MaintenanceRequestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RequestId,UnitId,TenantId,RequestDate,SkillId,Priority,Status,AssignedStaffId,Notes,CompletedDate")] MaintenanceRequest maintenanceRequest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RequestId,UnitId,TenantId,RequestDate,SkillId,Priority,Status,AssignedStaffId,Notes,CompletedDate")] MaintenanceRequest maintenanceRequest)
        {
