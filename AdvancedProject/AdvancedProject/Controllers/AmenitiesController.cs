...
namespace AdvancedProject.Controllers
{
    public class AmenitiesController : Controller
    {
        ...
        public AmenitiesController(APContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AmenityId,Name")] Amenity amenity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AmenityId,Name")] Amenity amenity)
        {
