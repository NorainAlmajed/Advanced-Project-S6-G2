...
namespace AdvancedProject.Controllers
{
    public class TenantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TenantId,Dob,NationalId,EmergencyContact,CreatedAt,UserId")] Tenant tenant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TenantId,Dob,NationalId,EmergencyContact,CreatedAt,UserId")] Tenant tenant)
        {
