...
namespace AdvancedProject.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentId,LeaseId,Amount,PaymentDate,Status,Notes")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,LeaseId,Amount,PaymentDate,Status,Notes")] Payment payment)
        {
